...
Before working on Kubetail, I co-founded a startup called [Octopart](https://octopart.com) that was a part of Y Combinator's W07 batch. We didn't do badly as far as startups go, so when I began working on Kubetail I followed a similar approach: I focused on building an MVP and as soon as it was ready, I posted it to Hacker News (HN). Thankfully, the HN post reached the front page for a few hours and we ended up with a couple of hundred GitHub stars and a small number of real users (~10).
