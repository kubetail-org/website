    ...
    starlight({
      plugins: [
        ...
        starlightLlmsTxt({
          ...
          description: `Kubetail is a general-purpose logging dashboard for Kubernetes, optimized for tailing logs across multi-container workloads in real-time.`,
        }),
      ],
      defaultLocale: "root",
      locales: {
      ...
      social: [
        {
          icon: "github",
          label: "GitHub",
          href: "https://github.com/kubetail-org/kubetail",
        },
        {
          icon: "discord",
          label: "Discord",
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [{ label: "Minikube", slug: "guides/integrations/minikube" }],
        },
        {
          label: "Reference",
          translations: {
