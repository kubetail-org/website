...
Kubetail can run both on your [desktop](/docs/getting-started/desktop) (via the CLI) and in your [cluster](/docs/getting-started/cluster) (as a deployment of the Dashboard docker image).
...
Follow the instructions [here](/docs/getting-started/desktop) to run Kubetail on your desktop.

**2. How can I install and access Kubetail in my cluster?**

Follow the instructions [here](/docs/getting-started/cluster) to run Kubetail inside your cluster.
