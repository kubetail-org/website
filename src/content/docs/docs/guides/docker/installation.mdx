---
title: Installation
description: "Pull the kubetail-cli image from Docker Hub (kubetail/kubetail-cli) or GHCR to run the Kubetail CLI in a container without installing it locally."
---
