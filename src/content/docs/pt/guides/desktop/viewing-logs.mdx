...
<Aside type="tip">
Para ver a lista completa de flags e opcoes de sintaxe de fonte, consulte a [referencia da CLI de `kubetail logs`](/pt/reference/cli#kubetail-logs).
</Aside>
...
O comando `kubetail cluster` usa Helm internamente, entao voce pode personalizar a instalacao com Helm depois, se quiser. Se preferir gerenciar a instalacao diretamente com Helm, consulte a [referencia do chart Helm](/pt/reference/helm-chart).
