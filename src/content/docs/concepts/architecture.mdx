...
See the [Docker introduction](/guides/docker/introduction) for more information about Docker deployment options.
...
See the [CLI reference](/reference/cli) for a full list of commands and flags.
...
See the [Dashboard reference](/reference/dashboard) for configuration options.
...
See the [Cluster API reference](/reference/cluster-api) for configuration options.
...
See the [Cluster Agent reference](/reference/cluster-agent) for configuration options.
...
<Aside type="tip">
For a deeper look at the performance implications of each topology, see the [Performance](/concepts/performance) page.
</Aside>
