...
description: "Kubetail now supports real-time log search powered by ripgrep. Install the Kubetail cluster agent to grep container logs on-node before any data leaves your cluster."
date: 2025-05-01
authors:
  - name: Andres Morey
