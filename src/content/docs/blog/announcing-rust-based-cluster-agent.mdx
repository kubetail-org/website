...
description: "The Kubetail cluster agent has been rewritten in Rust, cutting image size by 57% (10MB) and memory usage by 70% (~3MB) while maintaining the same feature set."
date: 2025-09-26
authors:
  - name: Andres Morey
