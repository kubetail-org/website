...
Voir l'[introduction à Docker](/fr/guides/docker/introduction) pour plus d'informations sur les options de déploiement avec Docker.
...
Voir la [référence de la CLI](/fr/reference/cli) pour la liste complète des commandes et des options.
...
Voir la [référence du Dashboard](/fr/reference/dashboard) pour les options de configuration.
...
Voir la [référence de la Cluster API](/fr/reference/cluster-api) pour les options de configuration.
...
Voir la [référence du Cluster Agent](/fr/reference/cluster-agent) pour les options de configuration.
...
<Aside type="tip">
Pour mieux comprendre les implications de performance de chaque topologie, consultez la page [Performance](/fr/concepts/performance).
</Aside>
