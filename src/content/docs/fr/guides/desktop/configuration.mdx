...
<Aside type="tip">
La commande `config init` accepte un indicateur `--format` pour choisir un autre format d'initialisation. Consultez la [reference CLI](/fr/reference/cli#kubetail-config-init) pour plus de details.
</Aside>
