...
Para empezar a usar Kubetail en desarrollo, solo tiene que instalar la CLI `kubetail` y ejecutar `kubetail serve` para ver logs en el navegador, o `kubetail logs` para enviarlos a su terminal (consulte [Inicio rápido](/es/tutorials/getting-started/quickstart)). No se requiere ninguna instalación del lado del clúster ni configurar previamente una canalización de reenvío de logs.
