...
En cualquiera de los dos casos, sus datos de logs permanecen en su poder de principio a fin (consulte [Arquitectura](/es/concepts/architecture) para más detalles).
